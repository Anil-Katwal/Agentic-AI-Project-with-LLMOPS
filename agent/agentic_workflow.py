    ...
    def agent_function(self, state: MessagesState):
        ...
        try:
            ...
            if not messages:
                ...
                return {"messages": [HumanMessage(content="No message provided")]}
            ...
            from langchain_core.messages import HumanMessage
            fallback_response = HumanMessage(content=f"I encountered an error while processing your request: {str(e)}. Please try again.")
